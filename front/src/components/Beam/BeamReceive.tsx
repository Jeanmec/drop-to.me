...
export default function BeamReceive() {
  ...
  return (
    <div
      className="bg-background relative mx-auto flex w-full max-w-[500px] items-center justify-center overflow-hidden"
      ref={containerRef}
    >
      ...
      <AnimatedBeam
        ...
        reverse
        dotted
        gradientStartColor="#d94848"
        gradientStopColor="#d9ff67"
      />
    </div>
  );
}
